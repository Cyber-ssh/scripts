...
SSHPRO () {
    bash <(wget -qO- https://cybercoari.com.br/master/sshplus)
}
SSHPLUS () {
...
SINCPRO () {
    bash <(wget -qO- https://cybercoari.com.br/cybercoari/sync/sincpainel.sh)
}
SINCPLUS () {
    apt install wget -y; bash <(wget -qO- https://cybercoari.com.br/cybercoari/sync/sincpainel.sh)
}
MENU () {
    clear
    menu
...
echo -e "\033[0;34m╠══════════════════════════════════════════════════════════════╣\033[0m"
echo -e "\033[00;34m║\033[1;31m\033[1;31m[\033[1;37m 01 •\033[1;31m]\033[1;37m ➩ \033[1;33m SCRIPT SSHPLUS\033[0;32m                                     \033[00;34m║"
